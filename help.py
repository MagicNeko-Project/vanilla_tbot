...
# 帮助
    help_text = f"""
喵～很高兴遇见你，亲爱的旅行者呐！✨ 
这里是由{env.MOEW_NAME}提供服务的机器人喵。以下是你可以跟我玩耍的命令列表喵～🐾

- <code>/start</code> - 开始和{env.MOEW_NAME}的奇妙之旅。
- <code>/hello</code> - 让{env.MOEW_NAME}给你最温暖的问候喵～
- <code>/version</code> - 告诉你，我们的友情等级现在是多少了哦！
- <code>/help</code> - 需要{env.MOEW_NAME}帮助的时候，随时召唤我喵。
...
- <code>/chat</code> - 和{env.MOEW_NAME}开始旅程吧喵!
- <code>/reset_chat</code> - 忘掉以前的对话，和{env.MOEW_NAME}开始一段新的旅程吧喵！
- <code>/ipinfo</code> - 查水表喵！

呜呼～{env.MOEW_NAME}在这里等着与你的每一次对话喵！如果你有任何疑问，或者想和我聊点什么，记得随时召唤我哦！🌟
{env.MOEW_NAME}的诞生离不开 CainSakura/NekoCato6/Yitong 你们的协助以及爆炸群友们努力的喵。
    """
